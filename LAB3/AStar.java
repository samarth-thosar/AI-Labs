...
//uses linked list to insert new node in ascendin order 
//another list as closed list for nodes that have been evaluated 
//manhattan distance to calculate distances between initial, current and goal states
            ...
            if (temp == null && temp1 == null) {
                ...
                while (temp != null) {
                    ...
                    if (isDifferent == false) {
                        if (temp.fa > ftemp) {
                            System.out.println("updating open");
                            temp.ibp = initial;
                            temp.fa = ftemp;
                            temp.ga = gtemp;
                        }
                ...
                if (check == false) {
                    while (temp1 != null) {
                        ...
                        if (isDifferent == false) {
                            System.out.println(temp1.fa + " " + ftemp + " " + temp1.ga + " " + gtemp);
                            if (temp1.fa > ftemp) {
